        ...
        Form {
            ...
            Section {
                    ...
                    Label {
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("Tap Update to download the IEEE MA-L registry, or bundle oui-mal.tsv.")
                                .font(.caption).foregroundStyle(.subnixMuted)
                        }
                ...
                case .updating:
                    HStack(spacing: 12) {
                        ProgressView()
                        Text("Downloading IEEE registry…").foregroundStyle(.subnixMuted)
                    }
                ...
                Text("Lookups are fully offline against the bundled table. “Update” is the only outside connection Subnix makes here — it downloads the latest IEEE MA-L registry, and only when you tap it.")
            }
        }
        .formStyle(.grouped)
        .subnixScreen()
